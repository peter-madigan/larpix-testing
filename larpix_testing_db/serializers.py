...
class ASICSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = ASIC
        fields = ['id', 'version', 'packaged', 'status', 'qrcode', 'note', 'entry_date', 'modification_date', 'url']
        read_only_fields = ['qrcode', 'entry_date', 'modification_date']

class PCBSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = PCB
        fields = ['id', 'version', 'status', 'qrcode', 'note', 'entry_date', 'modification_date', 'url']
        read_only_fields = ['qrcode', 'entry_date', 'modification_date']

class TestResultSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = TestResult
        fields = ['id', 'version', 'status', 'asics', 'pcbs', 'log', 'note', 'entry_date', 'modification_date', 'url']
